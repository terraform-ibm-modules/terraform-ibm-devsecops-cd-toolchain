...
| <a name="input_change_management_repo_initilization_type"></a> [change\_management\_repo\_initilization\_type](#input\_change\_management\_repo\_initilization\_type) | The initialization type for the repo. Can be `new`, `fork`, `clone`, `link`, `new_if_not_exists`, `clone_if_not_exists`, `fork_if_not_exists`. | `string` | `""` | no |
...
| <a name="input_code_signing_cert_secret_name"></a> [code\_signing\_cert\_secret\_name](#input\_code\_signing\_cert\_secret\_name) | Name of the code signing certificate secret in the secret provider. | `string` | `"code-signing-cert"` | no |
...
| <a name="input_deployment_repo_initilization_type"></a> [deployment\_repo\_initilization\_type](#input\_deployment\_repo\_initilization\_type) | The initialization type for the repo. Can be `new`, `fork`, `clone`, `link`, `new_if_not_exists`, `clone_if_not_exists`, `fork_if_not_exists`. | `string` | `""` | no |
