...
| <a name="input_artifactory_secret_crn"></a> [artifactory\_secret\_crn](#input\_artifactory\_secret\_crn) | The CRN for the Artifactory secret. | `string` | `""` | no |
...
| <a name="input_change_management_repo_secret_crn"></a> [change\_management\_repo\_secret\_crn](#input\_change\_management\_repo\_secret\_crn) | The CRN for the Change Managemenrt repository Git Token. | `string` | `""` | no |
...
| <a name="input_compliance_pipeline_repo_secret_crn"></a> [compliance\_pipeline\_repo\_secret\_crn](#input\_compliance\_pipeline\_repo\_secret\_crn) | The CRN for the Compliance Pipeline repository Git Token. | `string` | `""` | no |
...
| <a name="input_cos_secret_crn"></a> [cos\_secret\_crn](#input\_cos\_secret\_crn) | The CRN for the Cloud Object Storage apikey. | `string` | `""` | no |
...
| <a name="input_deployment_repo_secret_crn"></a> [deployment\_repo\_secret\_crn](#input\_deployment\_repo\_secret\_crn) | The CRN for the Deployment repository Git Token. | `string` | `""` | no |
...
| <a name="input_enable_signing_validation"></a> [enable\_signing\_validation](#input\_enable\_signing\_validation) | Enable for signing validation. | `bool` | `false` | no |
...
| <a name="input_evidence_repo_secret_crn"></a> [evidence\_repo\_secret\_crn](#input\_evidence\_repo\_secret\_crn) | The CRN for the Evidence repository Git Token. | `string` | `""` | no |
...
| <a name="input_inventory_repo_secret_crn"></a> [inventory\_repo\_secret\_crn](#input\_inventory\_repo\_secret\_crn) | The CRN for the Inventory repository Git Token. | `string` | `""` | no |
...
| <a name="input_issues_repo_secret_crn"></a> [issues\_repo\_secret\_crn](#input\_issues\_repo\_secret\_crn) | The CRN for the Issues repository Git Token. | `string` | `""` | no |
...
| <a name="input_pipeline_apikey_secret_crn"></a> [pipeline\_apikey\_secret\_crn](#input\_pipeline\_apikey\_secret\_crn) | The CRN for the pipeline apikey. | `string` | `""` | no |
...
| <a name="input_pipeline_config_repo_secret_crn"></a> [pipeline\_config\_repo\_secret\_crn](#input\_pipeline\_config\_repo\_secret\_crn) | The CRN for the Config repository Git Token. | `string` | `""` | no |
...
| <a name="input_privateworker_secret_crn"></a> [privateworker\_secret\_crn](#input\_privateworker\_secret\_crn) | The CRN for the Private Worker apikey. | `string` | `""` | no |
