resource "ibm_tekton_pipeline" "cd_pipeline_instance" {
...
resource "ibm_tekton_pipeline_definition" "cd_pipeline_definition" {
...
resource "ibm_tekton_pipeline_trigger" "cd_pipeline_manual_trigger" {
  pipeline_id       = ibm_tekton_pipeline.cd_pipeline_instance.pipeline_id
  trigger {
...
resource "ibm_tekton_pipeline_trigger" "cd_pipeline_promotion_trigger" {
  pipeline_id       = ibm_tekton_pipeline.cd_pipeline_instance.pipeline_id
  trigger {
