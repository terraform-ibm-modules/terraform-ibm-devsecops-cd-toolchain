...
resource "ibm_cd_tekton_pipeline_trigger_property" "cd_pipeline_manual_pruner_trigger_property_batch" {
  ...
  value       = "1000"
  pipeline_id = ibm_cd_tekton_pipeline.cd_pipeline_instance.pipeline_id
  trigger_id  = ibm_cd_tekton_pipeline_trigger.cd_pipeline_manual_pruner_trigger[0].trigger_id
}
...
resource "ibm_cd_tekton_pipeline_trigger_property" "cd_pipeline_timed_pruner_trigger_property_batch" {
  ...
  value       = "1000"
  pipeline_id = ibm_cd_tekton_pipeline.cd_pipeline_instance.pipeline_id
  trigger_id  = ibm_cd_tekton_pipeline_trigger.cd_pipeline_timed_pruner_trigger[0].trigger_id
}
