...
| <a name="input_private_worker_integration_name"></a> [private\_worker\_integration\_name](#input\_private\_worker\_integration\_name) | The name of the private worker integration. | `string` | `"compliance-private-worker"` | no |
